  ...
  export function App() {
    ...
    return (
      <React.StrictMode>
        <div className="bg-[#c4e5e7] min-h-screen flex flex-col justify-center items-center">
          <div>
            <Header />
          </div>

          <div className="  bg-white rounded-[20px] p-[61px] w-full max-w-[1150px] mt-[4%] lg:flex lg:flex-row max-md:max-w-[90%] max-md:p-[30px] max-md:mt-[40px] md:flex-col sm:w-[100%] max-sm:p-[20px] sm:mt-[20px]  sm:items-center">
            <TipInputForm
